...
$ignore_detect_lang_page = array(
    ...
    '/api/payment/severpay_rub/'.PAYMENT_KEY,
    '/api/payment/severpay_rub2/'.PAYMENT_KEY,
    ...
    '/api/payment/betatransfer/'.PAYMENT_KEY,
    '/api/payment/wayforpay/'.PAYMENT_KEY,
    '/api/payment/liqpay/'.PAYMENT_KEY,
    '/api/payment/pay4game/'.PAYMENT_KEY,
    '/api/payment/changecoins/'.PAYMENT_KEY,
    '/text',
    '/captcha/altcha',
    '/prefix/refresh',
    '/promo-game',
